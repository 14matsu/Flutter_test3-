...
import 'package:time_watch_app/constans/routes.dart' as routes;
        ...
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () async {
              ...
              if (added != null && added) {
                final snackBar = SnackBar(
                  backgroundColor: Color.fromARGB(255, 93, 162, 246),
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              child: const Text('はい'),
              onPressed: () async {
                await model.deletePhotoData(book);
                Navigator.of(context).pop();
                final snackBar = SnackBar(
